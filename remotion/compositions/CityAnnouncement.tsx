import { useCurrentFrame, AbsoluteFill, Video, interpolate, staticFile, spring } from 'remotion';

export const CityAnnouncement: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      {/* Background video */}
      <Video
        src={staticFile('videos/city-source.mp4')}
        startFrom={0}
        playbackRate={1}
      />
